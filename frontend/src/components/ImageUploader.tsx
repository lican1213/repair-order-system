  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {previews.length < maxFiles && (
        <label className={`inline-flex items-center justify-center min-h-[44px] px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-500 cursor-pointer transition-colors ${dropHover}`}>
